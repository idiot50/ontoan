/*
 * run.mjs — chạy TẤT CẢ test (engine / check / safety / ui), in tổng kết
...
console.log('================ BỘ TEST WEB TOÁN LỚP 3 ================\n');
...
// Ghi chú UI nếu bị skip (chưa tự động hoá).
const ui = groups.find(g => g.group === 'UI');
if (ui && ui.skipped) {
  console.log('\nGhi chú UI: phần kiểm GIAO DIỆN headless chưa chạy được trên máy này.');
  console.log('  -> Kiểm thủ công: mở d:\\toanlop3\\web_toan_lop3\\index.html bằng Chrome/Edge.');
}
